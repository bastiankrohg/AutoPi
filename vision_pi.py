...
class VisionPi:
    ...
    def compare_images(self):
        ...
        print(f"Taux de differentiation : {difference_rate:.2f}%")
    ...
    def test_bottle_detection(self) :
        ...
        print(f"[{datetime.datetime.now()}] Image processing complete. Potential bottles detected: {bottle_count}.")
    ...
    def calcul_direction(self):
        ...
        if self.result is None:
            print("Erreur: Aucune detection, impossible de calculer la direction.")
            return
    ...
    def one_image_processing_hybrid(self):
        ...
        if new_image is not None:
            ...
            if difference < 0.1 :
                ...
                print(f"[{datetime.datetime.now()}] Images are moderately different (10%-70%). waiting for coral.")
